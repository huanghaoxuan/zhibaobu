 ...
 *
 * 表名：zhuanyejianshezonghegaige
 * 表含义：专业建设综合改革
 **/

@Entity
@Table(name = "zhuanyejianshezonghegaige")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Accessors(chain = true)
public class Zhuanyejianshezonghegaige implements Serializable {
    private static final long serialVersionUID = -5413146052840795561L;
